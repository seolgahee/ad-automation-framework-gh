...
- **TikTok 플랫폼**: `db.js`의 CHECK 제약조건에 `'tiktok'`이 아직 추가되지 않았습니다 — TikTok 데이터 수집 전에 해당 제약조건을 업데이트해야 합니다 (CODE_REVIEW_v7.md HIGH-001 참조)
